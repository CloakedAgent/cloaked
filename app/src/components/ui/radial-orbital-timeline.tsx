...
export default function RadialOrbitalTimeline({
  ...
  // Detect mobile viewport for responsive radius
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-20 h-20 rounded-full bg-black border-2 border-white/20 flex items-center justify-center z-10 shadow-lg shadow-white/10">
            <div
          ...
          <div className={`absolute rounded-full border border-white/10 ${isMobile ? 'w-72 h-72' : 'w-96 h-96'}`}></div>
              ...
              <div
                ...
                style={{
                  ...
                  transition: autoRotate
                    ? 'opacity 0.3s ease-out, z-index 0s'
                    : 'all 0.7s ease-out',
                }}
                onClick={(e) => {
                  e.stopPropagation();
